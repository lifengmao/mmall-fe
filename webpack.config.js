...
var config = {
  entry:{
    ...
    'order-confirm':path.resolve(__dirname,'./src/page/order-confirm/index.js'),
    'order-list':path.resolve(__dirname,'./src/page/order-list/index.js'),
    'order-detail':path.resolve(__dirname,'./src/page/order-detail/index.js'),
    'payment':path.resolve(__dirname,'./src/page/payment/index.js'),
  ...
  plugins:[
    ...
    new HtmlWebpackPlugin(getHtmlConfig('order-detail','详情')),
